...
export default function HomePage() {
  ...
  return (
    <>
        ...
        <main className="home-main">
          <div className="home-hero">
            ...
            <div className="home-ctas">
              ...
              <a href="#peek" className="home-cta home-cta-quiet">
                <span className="cta-icon">&#9993;</span> Look around
              </a>
            </div>
      ...
      <style>{`
        .home-loader { display: flex; align-items: center; justify-content: center; min-height: 60vh; }
        .home-loader .spinner { width: 40px; height: 40px; border: 3px solid #e0d5c0; border-top-color: #8b4513; border-radius: 50%; animation: spin .8s linear infinite; }
        @keyframes spin { to { transform: rotate(360deg); } }
        .home-main { padding-bottom: 60px; position: relative; }
        .home-hero { text-align: center; padding: 40px 16px 28px; position: relative; overflow: hidden;
          background: linear-gradient(180deg, #fefdf9 0%, #faf7f0 100%); border-bottom: 1px solid #e8dcc8; }
        .ink-blot { position: absolute; border-radius: 50%; pointer-events: none; filter: blur(50px); opacity: 0.12; z-index: 0; }
        .ink-blot-1 { width: 280px; height: 280px; background: radial-gradient(circle, #4a3018, #8b6948, transparent); top: -80px; left: -40px; }
        .ink-blot-2 { width: 200px; height: 200px; background: radial-gradient(circle, #54381c, #96764e, transparent); bottom: -40px; right: -20px; }
        .home-title { font-size: 34px; font-weight: 700; line-height: 1.2; position: relative; z-index: 1; color: var(--ink, #1a1a1a); letter-spacing: -0.5px; margin-bottom: 0; }
        .home-flourish { width: 190px; height: 13px; margin: 2px auto 8px; display: block; position: relative; z-index: 1; }
        .home-sub { font-size: 14px; color: #8c7a60; font-style: italic; position: relative; z-index: 1; margin-bottom: 16px; }
        ...
        .home-cta { display: inline-flex; align-items: center; gap: 8px; padding: 12px 28px; background: #1a1a1a; color: #fff; border-radius: 8px; font-weight: 700; font-size: 15px; position: relative; z-index: 1; box-shadow: 0 4px 20px rgba(0,0,0,0.18); transition: transform 0.15s, box-shadow 0.15s; text-decoration: none; }
        .home-cta:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(0,0,0,0.18); }
